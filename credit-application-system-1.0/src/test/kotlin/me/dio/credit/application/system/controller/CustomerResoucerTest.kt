...
class CustomerResoucerTest {
    ...
    @Test
    fun should_creat_a_customer_and_return_201_status() {
        ...
        //when - para testar o metodo que queremos |
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("cami@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua Cami, 123"))
